                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Card(
                              ...
                              child: image != null
                                  ? Image.file(File(image.path), height: 130, width: 130, fit: BoxFit.cover, alignment: Alignment.center)
                                  : appStore.userProfileImage.validate().isNotEmpty
                                      ? cachedImage(appStore.userProfileImage, height: 130, width: 130, fit: BoxFit.cover, alignment: Alignment.center)
