                  ...
                  children: [
                    ...
                    SettingItemWidget(
                      ...
                      trailing: DropdownButton<FontSizeModel>(
                        items: fontSizes
                            .map(
                              (e) => DropdownMenuItem<FontSizeModel>(child: Text('${e.title}', style: primaryTextStyle(size: 14)), value: e),
                            )
                            .toList(),
                    ...
                    SettingItemWidget(
                      ...
                      title: '${appLocalization.translate('share')} ${appLocalization.translate('app_name')}',
                      onTap: () {
