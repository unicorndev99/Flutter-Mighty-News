...
Future<void> loginWithOTP(BuildContext context, String phoneNumber) async {
  return await _auth.verifyPhoneNumber(
    ...
    verificationCompleted: (PhoneAuthCredential credential) async {
      //finish(context);
      //await showInDialog(context, child: OTPDialog(isCodeSent: true, phoneNumber: phoneNumber, credential: credential), shape: dialogShape(), backgroundColor: Colors.black);
    },
    ...
    codeSent: (String verificationId, int resendToken) async {
      finish(context);
      await showInDialog(context, child: OTPDialog(verificationId: verificationId, isCodeSent: true, phoneNumber: phoneNumber), shape: dialogShape(), barrierDismissible: false);
    },
