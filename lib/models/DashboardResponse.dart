class DashboardResponse {
  ...
  DashboardResponse({this.app_lang, this.banner, this.feature_num_pages, this.videos, this.breaking_post, this.recent_num_pages, this.recent_post, this.social_link});
