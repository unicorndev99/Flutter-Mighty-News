...
class Language {
  ...
  static List<Language> getLanguages() {
    return <Language>[
      ...
      Language(1, 'Gujarati', 'gu', 'assets/flags/ic_india.png', 'gu-IN'),
      Language(2, 'Hindi', 'hi', 'assets/flags/ic_india.png', 'hi-IN'),
      Language(3, 'Arabic', 'ar', 'assets/flags/ic_ar.png', 'ar-AR'),
      Language(4, 'German', 'de', 'assets/flags/ic_germany.png', 'de-DE'),
      Language(5, 'Dutch', 'nl', 'assets/flags/ic_netherlands.png', 'nl-NL'),
      Language(6, 'Russian', 'ru', 'assets/flags/ic_russia.png', 'ru-RU'),
      Language(7, 'Turkish', 'tr', 'assets/flags/ic_turkey.png', 'tr-TR'),
      Language(8, 'Bangla', 'bn', 'assets/flags/ic_bangladesh.png', 'bn-BN'),
      Language(9, 'French', 'fr', 'assets/flags/ic_french.png', 'fr-FR'),
      Language(9, 'Urdu', 'ur', 'assets/flags/ic_pakistan.png', 'ur-UR'),
    ];
  }
