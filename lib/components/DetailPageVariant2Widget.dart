        ...
        children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(appLocalization.translate('NEWS'), style: boldTextStyle(color: Colors.white, size: 8)),
                        decoration: boxDecorationRoundedWithShadow(defaultRadius.toInt(), backgroundColor: colorPrimary),
                      ),
                      Row(
                        children: [
                          Icon(Icons.access_time_rounded, color: Colors.white, size: 16),
                          4.width,
                          Text(widget.newsData.readable_date, style: secondaryTextStyle(color: Colors.white)),
                        ],
                      ),
                    ],
          ...
          Positioned(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Container(child: BackButton(), decoration: BoxDecoration(color: Theme.of(context).scaffoldBackgroundColor, shape: BoxShape.circle, boxShadow: defaultBoxShadow())),
                Row(
                  children: [
                    IconButton(
                      icon: Container(
                        child: Icon(widget.newsData.is_fav.validate() ? FontAwesome.bookmark : FontAwesome.bookmark_o),
                        decoration: BoxDecoration(color: Theme.of(context).scaffoldBackgroundColor, shape: BoxShape.circle, boxShadow: defaultBoxShadow()),
