  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          cachedImage(widget.newsData.image.validate(), fit: BoxFit.cover).cornerRadiusWithClipRRect(defaultRadius - 4),
          ...
          Column(
            ...
            children: [
              Text(
                parseHtmlString(widget.newsData.readable_date.validate()),
                maxLines: 1,
